                       ...
                       <div class="row">
                                 ...
                                 <div class="single-product-tab">
                                    <div class="zoomWrapper">
                                        <div id="img-1" class="zoomWrapper single-zoom">
                                            <a href="#">
                                                <img id="zoom1" src="img/single-product/3.jpg" data-zoom-image="img/single-product/3.jpg" alt="big-1">
                                            </a>
                                        </div>
                            ...
                            <div class="col-md-5 col-sm-6 col-xs-12">
                                <div class="single-product-detels">
                                    <h4 class="single-product-title">Dot Bike Euro Mountain Bike</h4>
                                    
                                    <div class="single-price-box">
                                        <div class="tutole-price"><span>$350.00</span></div>
                                        <div class="revew">
                                ...
                                <div class="product-det-tab">
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="cont-pd tab-pane active" id="Description">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iusto iure quia veritatis atque accusantium quaerat. Fugiat nisi, pariatur odit veniam voluptas dolor temporibus minima asperiores enim, sequi cum tempore unde</div>
